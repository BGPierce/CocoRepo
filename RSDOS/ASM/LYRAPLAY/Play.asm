...
DSP_STRT FDB 0,0,0,0,0,0,0,0 display pointers to voices
CNT_STRT RZB 8 starting offset for CNT_CURS
MEA_STRT FDB 0 starting measure count
BNUM_ST FDB 0 starting barline number
VOI_CNT FDB 0,0,0,0,0,0,0,0 voice counter from start of music

*pointers and counters at cursor position
DSP_CURS FDB 0,0,0,0,0,0,0,0 cursor display pointers
CNT_CURS FCB 0,0,0,0,0,0,0,0 note value
...
DSP_NXT FDB 0,0,0,0,0,0,0,0
CNT_NXT FCB 0,0,0,0,0,0,0,0
VOI_NXT FCB 0
MEA_NXT FDB 0
BNUM_NXT FDB 0
...
TIENEXT FCB 0,0,0,0,0,0,0,0 >0=nxt note tied, note off afcted
TIEFLAG FCB 0,0,0,0,0,0,0,0 >0 = note tied, affects note on
...
OCTVTABL FCB 0,0,0,0,0,0,0,0 octave up/down offsets
MIDILNOT FCB 0,0,0,0,0,0,0,0 last note pitch played
 FCB 0,0,0,0,0,0,0,0
...
L@ LBSR GETLCHRD
 ...
 TSTA
 BNE L@
M@ LDX #$FF00 turn off sound port.
 LDA #$34
 STA $23,X
 LDA #8
 ORA 1,X
...
LNOTSIZ EQU 5
LNOTES FCB 0,0,0,0,0 notes: pointer,count,pitch
 FCB 0,0,0,0,0
 FCB 0,0,0,0,0
 FCB 0,0,0,0,0
 FCB 0,0,0,0,0
